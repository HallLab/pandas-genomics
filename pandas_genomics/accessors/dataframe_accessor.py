...
@pd.api.extensions.register_dataframe_accessor("genotyping")
class GenotypeDataframeAccessor:
    ...
    def __init__(self, pandas_obj):
        for colname in pandas_obj.columns:
            ...
            if not GenotypeDtype.is_dtype(pandas_obj[colname].dtype):
    ...
    def variant_info(self):
        ...
        return pd.DataFrame({
            colname: self._obj[colname].genotyping.variant_info
